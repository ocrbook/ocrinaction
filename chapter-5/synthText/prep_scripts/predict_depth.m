...
function predict_depth()
    ...
    opts.imdir = '../../my_img/img_dir';
    opts.out_h5 = '../../my_img/depth.h5';
    % these should point to the pre-trained models from:
    %  https://bitbucket.org/fayao/dcnf-fcsp/
    opts.model_file.indoor =  '../model_trained/model_dcnf-fcsp_NYUD2.mat';
    opts.model_file.outdoor =  '../model_trained/model_dcnf-fcsp_Make3D.mat';
